...
* @returns {string}
*/
module.exports.calculate_global_farm_reward_per_period = function(yield_per_period, total_farm_shares_z, max_reward_per_period) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
module.exports.calculate_adjusted_shares = function(shares, price_adjustment) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(shares, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
